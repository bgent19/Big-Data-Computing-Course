# SD411 lab02 Worksheet -- HDFS vs MinIO
...
**1.3** Run `mc stat local/sd411/lab02/big.csv` inside the mc container. Name one
...
| | 1 x season seed (big.csv) | 500 x small files |
|---|---|---|
...
| | HDFS `hdfs dfs -ls /small` | MinIO `mc ls local/sd411/lab02/small/` |
|---|---|---|
...
## Stretch (optional) -- Spark reads both
...
measurements from this worksheet as evidence, acknowledge one way the single-VM
...
prose per the SD322 writing standard; this is the part of the lab a future
...
you kept. "None" is an acceptable answer. You will defend every line of this
worksheet orally, so the statement protects you, not us.
